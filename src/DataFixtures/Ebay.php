...
class Ebay
{
	...
	public function getParentCategoryIdByName(string $category = "CDs"): int
	{
		...
		if ($category == "Video Games $ Consoles" && $this->globalId == "EBAY-US") {
			$categoryId = 1249; // Video games EBAY-US
		}
		if ($category == "Video Games $ Consoles" && $this->globalId == "EBAY-FR") {
			$categoryId = 1249; // Video games EBAY-FR
		}
		if ($category == "Video Games" && $this->globalId == "EBAY-US") {
			$categoryId = 139973; // Video games EBAY-US
		}
		if ($category == "Video Games" && $this->globalId == "EBAY-FR") {
			$categoryId = 139973; // Video games EBAY-FR
		}
		if ($category == "Movie" && $this->globalId == "EBAY-US") {
			$categoryId = 32852; // Video games EBAY-US
		}
		if ($category == "Movie" && $this->globalId == "EBAY-FR") {
			$categoryId = 32852; // Video games EBAY-FR
		}
	...
	public function getParentCategoryIdById(int|string $id): int
	{
		...
		$tabIdCategories[1249] = 1249; // Video Games $ Consoles
		$tabIdCategories[139973] = 1249; // Video Games

		//Video Games
		$tabIdCategories[139973] = 139973; // Video Games
	 ...
	 */
	public function findItemsAdvanced(?string $keywords = "", int $entries_per_page = 3): ?string
	{
